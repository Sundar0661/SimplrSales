        ...
        .sortable({
            ...
            receive: function (dataTo, dataFrom, e) {
                ...
                if (ProjectName.toLowerCase() == "poc") {
                    ...
                    if (ProjectName.toLowerCase() == "wms-lsh" || ProjectName.toLowerCase() == "unitrade" || ProjectName.toLowerCase() == "ricwil" || ProjectName.toLowerCase() == "sandl") {
                        qry = "update Orderhdr set AgentId='" + vehicleId + "',  VehicleId='" + vehicleId + "' where OrdNo='" + ordNo + "'";
                    }
                    else {
...
function GetVehicleList_sub() {
    ...
    if (ProjectName.toLowerCase() == "jsu") {
        ...
        ProjectName.toLowerCase() == "wms-lsh" || ProjectName.toLowerCase() == "unitrade" || ProjectName.toLowerCase() == "ricwil" || ProjectName.toLowerCase() == "sandl") {
        qry = "select * from Vehicle order BY displayno ";
    }
...
function LoadVehicle(data) {
    ...
    if (data != null) {
        for (var i = 0; i < data.length; i++) {
            ...
            //htm += '<div  id="divbackRoundColor' + i + '"  style="background-color: Green; height: 37px;margin-top:-1px">';
            ...
            //htm += '<a  id="printbtnbackRoundColor' + i + '"  href="#"  class="w3-button " style="color: white;background-color: Green;"><span class="glyphicon glyphicon-print"></span></a>';
            ////  htm += '<button class="w3-button w3-black">Hover Over Me!</button>';
            htm += '<div class="w3-dropdown-content w3-bar-block w3-border">';
            //htm += '<input type="button"  onclick="PrintPicking(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button" style="font-size: 13px;" value="Print Picking">';
            //htm += '<input type="button"  onclick="PrintPickingConsolidated(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button" style="font-size: 13px;" value="Print Picking Consolidated">';
            //htm += '<input type="button" onclick="CreateInvoice(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button" style="font-size: 13px;" value="Create Invoice">';
            if (ProjectName.toLowerCase() != "etika" && ProjectName.toLowerCase() != "poc" && ProjectName.toLowerCase() != "wms-lsh" && ProjectName.toLowerCase() != "unitrade" && ProjectName.toLowerCase() != "ricwil" && ProjectName.toLowerCase() != "sandl" && ProjectName.toLowerCase() != "tradeprofd") {
                htm += '<a   onclick="PrintPicking(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button">Print Picking</a>';
            }
            if (ProjectName.toLowerCase() != "etika" && ProjectName.toLowerCase() != "tradeprofd")
            ...
            //if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "lsh") {
            ...
            else if (ProjectName.toLowerCase() == "pvm" || ProjectName.toLowerCase() == "etika") {
                htm += '<a   onclick="CreateInvoicePVM(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button">Create Invoice</a>';
            }


            else if (ProjectName.toLowerCase() == "poc" || ProjectName.toLowerCase() == "wms-lsh" || ProjectName.toLowerCase() == "unitrade" || ProjectName.toLowerCase() == "ricwil" || ProjectName.toLowerCase() == "sandl") {
            ...
            //
            if (ProjectName.toLowerCase() == "tradeprofd") {
            ...
            else if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
            ...
            //htm += ' <span style="margin-left:5px;font-size:13px;font-weight:bold;color:white;">' + data[i].Description + " - " + data[i].Length * data[i].Width * data[i].Height + " CBM - " + "TOTAL TIME :  " + '</span> <span style="font-size:13px;font-weight:bold;color:red;" id="div' + i + '_tottimeCalculation"></span>';
            //htm += ' <span id="tottimeCalculation"></span>';

            //htm += ' <span style="margin-left:100px;font-size:18px;font-weight:bold;color:white;">' + data[i].Description + " - " + data[i].Length * data[i].Width * data[i].Height + " CBM " + '</span>';
            //htm += ' <span style="margin-left:100px;font-size:18px;font-weight:bold;color:white;">' + " TOTAL TIME : 1233 min(s) " + '</span>';
            ...
            htm += '</div>';
            // htm += '<div style="height: 300px; overflow-y: scroll">';
            ...
            //   htm += '<table id="table' + i + '" class="table table-striped table-bordered tableId" style="width: 99%; margin-left: 4px;">';
            //htm += '<table id="table' + i + '" class="mytable" style="width: 99%; margin-left: 4px;">';
            //tbodyId = data[i].Code.replace(/ /g, '');
            //newly added by.M 17.11.2021
            tbodyId = vehicleData[i].Code.replace(/ /g, '').replace("/", "");
            // += '<tbody class="' + data[i].Code + ' connectedSortable" value="' + data[i].Code + '"   id="' + tbodyId + '_' + i + '"    style="font-size:.8em;">';
            ...
            else if (ProjectName.toLowerCase() != "pod" && ProjectName.toLowerCase() != "poc" && ProjectName.toLowerCase() != "wms-lsh" && ProjectName.toLowerCase() != "unitrade" && ProjectName.toLowerCase() != "ricwil" && ProjectName.toLowerCase() != "sandl") {
            ...
            if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "tradeprofd") {
            ...
            if (ProjectName.toLowerCase() != "poc" && ProjectName.toLowerCase() != "wms-lsh" && ProjectName.toLowerCase() != "unitrade" && ProjectName.toLowerCase() != "ricwil"
                && ProjectName.toLowerCase() != "sandl") {
            ...
            if ((ProjectName.toLowerCase() != "pvm" && ProjectName.toLowerCase() != "wms" && ProjectName.toLowerCase() != "laponie" && ProjectName.toLowerCase() != "wil" && ProjectName.toLowerCase() != "leonsynergy") || ProjectName.toLowerCase() == "etika") {
...
function GetVehicleData() {
    ...
    else if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "pod" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
        UpdateOrderVehicle();
    }
    ...
    if (ProjectName.toLowerCase() != "jsu") {
        ...
        if (ProjectName.toLowerCase() == "wms") {
            ...
            //comm By.M 16.09.2021
            //qry = "select b.TotalAmt as Amount,Case When ISNULL(b.VehicleID,'')='' then \n";
            //qry += "(select top 1 Code from vehicle Where IsBUffer=1 and Branch=b.LocationCode) Else b.VehicleID End as VehicleID, \n";
            //qry += "s.City as Territory, a.OrdNo as OrdNo, Sum(a.Cubage) as Cubage, Isnull(Sum(a.ItemCaseQty),0) as CaseQty, \n";
            //qry += "s.Name as CustomerName\n";
            //qry += ",S.Address1+(Case When ISNULL(S.Address2,'')='' Then'' Else ', '+ S.Address2 End)+(Case When ISNULL(S.City,'')='' \n";
            //qry += "Then'' Else ', '+ S.City End) as CustAddress,\n";
            //qry += "c.ZoneCode as AlternateShipAgent, b.DeliveryDate from (select OrdItem.OrdNo, (select top 1 (Cubage / BaseQty) * OrdItem.Qty\n";
            //qry += "from UOM inner join Item on Item.ItemNo=UOM.ItemNo where Uom.ItemNo=OrdItem.ItemNo and Uom.Uom=Item.BulkUOM) as Cubage,\n";
            //qry += " OrdItem.Qty as ItemCaseQty from OrdItem) a\n";
            //qry += "INNER JOIN OrderHdr b on a.OrdNo=b.OrdNo\n";
            ...
            //qry += "INNER JOIN LocationGroup LM on LM.GroupID=b.LocationCode\n";
            //qry += "INNER JOIN vehicle V on V.Branch=LM.GroupID\n";
            //qry += "Left Join  ShiptoAddress S on S.CustNO=b.CustID and S.CustomerAddressID =b.ShiptoCode\n";
            //qry += "where b.DeliveryDate between ('" + deliverydate + " 00:00:00 " + "') and ('" + deliverydate + " 23:59:59 " + "') \n";
            //qry += "and (b.Void=0 or b.Void is null) and b.CustID = c.CustNo and isnull(PickingStatus,0) < 8 and b.OrdNo not in \n";
            //qry += "(select OrdNo from invoice where (Void = 0 or Void is null)) and LM.USerID='" + _UserID + "' group by a.OrdNo, b.TotalAmt, c.SalesAgent, s.Name, \n";
            //qry += "S.Address1,S.Address2,S.City,c.ZoneCode,b.DeliveryDate,b.VehicleID,b.LocationCode ";

            //newlyadded By.M 16.09.2021
            ...
            //qry = "select b.TotalAmt as Amount,Case When ISNULL(b.VehicleID,'')='' then (select top 1 Code from vehicle Where IsBUffer=1 and Branch in (select GroupID from LocationGroup Where UserID='" + _UserID + "')) Else b.VehicleID End as VehicleID, s.City as Territory, a.OrdNo as OrdNo, Sum(a.Cubage) as Cubage, Isnull(Sum(a.ItemCaseQty),0) as CaseQty, s.Name as CustomerName  \n";            //qry += ",S.Address1+(Case When ISNULL(S.Address2,'')='' Then'' Else ', '+ S.Address2 End)+(Case When ISNULL(S.City,'')=''  \n";            //qry += "Then'' Else ', '+ S.City End) as CustAddress \n";            //qry += ",c.ZoneCode as AlternateShipAgent, b.DeliveryDate from (select OrdItem.OrdNo, (select top 1 (Cubage / BaseQty) * OrdItem.Qty \n";            //qry += "from UOM inner join Item on Item.ItemNo=UOM.ItemNo where Uom.ItemNo=OrdItem.ItemNo and Uom.Uom in (select Top 1 UOM from UOM Where ItemNO=OrdItem.ItemNo order by BAseQty Desc)) as Cubage,\n";            //qry += "OrdItem.Qty as ItemCaseQty from OrdItem) a \n";            //qry += "INNER JOIN OrderHdr b on a.OrdNo=b.OrdNo \n";            //qry += "INNER JOIN Customer c on b.CustID = c.CustNo \n";            //qry += "INNER JOIN LocationGroup LM on LM.GroupID=b.LocationCode \n";            //qry += "Left JOIN vehicle V on V.Branch=LM.GroupID \n";            //qry += "Left Join  ShiptoAddress S on S.CustNO=b.CustID and S.CustomerAddressID =b.ShiptoCode \n";            //qry += "where b.DeliveryDate between ('" + deliverydate + " 00:00:00 " + "') and ('" + deliverydate + " 23:59:59 " + "') \n";            //qry += "and (b.Void=0 or b.Void is null) and b.CustID = c.CustNo and isnull(PickingStatus,0) < 8 and b.OrdNo not in \n";            //qry += "(select OrdNo from invoice where (Void = 0 or Void is null)) and LM.USerID='" + _UserID + "' group by a.OrdNo, b.TotalAmt, c.SalesAgent, s.Name, \n";            //qry += "S.Address1,S.Address2,S.City,c.ZoneCode,b.DeliveryDate,b.VehicleID,b.LocationCode  \n";
            ...
            qry += "group by a.OrdNo, b.TotalAmt, c.SalesAgent, c.CustName, C.Address,C.Address2,C.City,c.ZoneCode,b.DeliveryDate,b.VehicleID,b.LocationCode , Category \n";
            ...
            //qry = "select b.TotalAmt as Amount,b.companyno,Case When ISNULL(b.VehicleID,'')='' then (select top 1 Code from vehicle Where IsBUffer=1) Else b.VehicleID End as VehicleID, c.City as Territory, a.OrdNo as OrdNo, Sum(a.Cubage) as Cubage, Isnull(Sum(a.ItemCaseQty),0) as CaseQty, c.CustName as CustomerName   \n";
            //qry += ",C.Address+(Case When ISNULL(C.Address2,'')='' Then'' Else ', '+ C.Address2 End)+(Case When ISNULL(C.City,'')='' \n";
            //qry += "Then'' Else ', '+ C.City End) as CustAddress\n";
            //qry += ",c.ZoneCode as AlternateShipAgent, b.DeliveryDate from (select OrdItem.OrdNo, (select top 1 (Cubage / BaseQty) * OrdItem.Qty   \n";
            //qry += "from UOM inner join Item on Item.ItemNo=UOM.ItemNo where Uom.ItemNo=OrdItem.ItemNo and Uom.Uom=Item.BulkUOM) as Cubage,    \n";
            ...
            // COMMENTED GOPAL GIVEN BELOW QUERY 23.04.2021 ================================================
            //qry = " select SoldTo,NoSeries,DeliveryDate ,Amount,companyno,VehicleID, Territory, OrdNo, Cubage, CaseQty, CustomerName from ";
            //qry += " (select P.SoldTo,(select top 1 NoSeries from OrderSeries Where a.OrdNo Like Replace(NoSeries,'*','')+'%') as NoSeries ,b.TotalAmt as Amount,b.companyno,Case When ISNULL(b.VehicleID,'')='' then (select top 1 Code from vehicle Where IsBUffer=1) Else b.VehicleID End as VehicleID, c.City as Territory, a.OrdNo as OrdNo, Sum(a.Cubage) as Cubage, Isnull(Sum(a.ItemCaseQty),0) as CaseQty, c.CustName as CustomerName ";
            //qry += " ,C.Address+(Case When ISNULL(C.Address2,'')='' Then'' Else ', '+ C.Address2 End)+(Case When ISNULL(C.City,'')='' ";
            //qry += " Then'' Else ', '+ C.City End) as CustAddress ";
            //qry += " ,c.ZoneCode as AlternateShipAgent, b.DeliveryDate from (select OrdItem.OrdNo, (select top 1 (Cubage / BaseQty) * OrdItem.Qty ";
            //qry += " from UOM inner join Item on Item.ItemNo=UOM.ItemNo where Uom.ItemNo=OrdItem.ItemNo and Uom.Uom=Item.BulkUOM) as Cubage, ";
            ...
            //qry += " where (b.Void=0 or b.Void is null) and b.CustID = c.CustNo and isnull(PickingStatus,0) < 8 and b.OrdNo not in (select OrdNo from invoice where (Void = 0 or Void is null)) ";
            //qry += " group by b.companyno, a.OrdNo, b.TotalAmt, c.SalesAgent, c.CustName, C.Address,C.Address2,C.City, c.ZoneCode,b.DeliveryDate,b.VehicleID ,P.SoldTo) as A1 ";
            ...
            // GOPAL GAVE ON 28.04.2021
            //qry = " select SoldTo,NoSeries,DeliveryDate ,Amount,companyno,VehicleID, Territory, OrdNo, Cubage, CaseQty, CustomerName from ";
            //qry += " (select P.SoldTo,(select top 1 NoSeries from OrderSeries Where a.OrdNo Like Replace(NoSeries,'*','')+'%') as NoSeries ,b.TotalAmt as Amount,b.companyno,Case When ISNULL(b.VehicleID,'')='' ";
            //qry += " then (select top 1 Code from vehicle Where IsBUffer=1) Else b.VehicleID End as VehicleID, c.City as Territory, a.OrdNo as OrdNo, Sum(a.Cubage) as Cubage, Isnull(Sum(a.ItemCaseQty),0) as CaseQty, ";
            //qry += " c.CustName as CustomerName ";
            //qry += " ,C.Address+(Case When ISNULL(C.Address2,'')='' Then'' Else ', '+ C.Address2 End)+(Case When ISNULL(C.City,'')='' ";
            //qry += " Then'' Else ', '+ C.City End) as CustAddress ";
            //qry += " ,c.ZoneCode as AlternateShipAgent, b.DeliveryDate from (select OrdItem.OrdNo, (select top 1 (Cubage / BaseQty) * OrdItem.Qty ";
            ...
            //qry += " from UOM inner join Item on Item.ItemNo=UOM.ItemNo where Uom.ItemNo=OrdItem.ItemNo and Uom.Uom=Item.BulkUOM)) as ItemCaseQty from OrdItem) a ";
            //qry += " INNER JOIN OrderHdr b on a.OrdNo=b.OrdNo ";
            //qry += " inner join (select OrdNo,Count(*) as count, (select Count(*) from OrdItem O where OrdItem.OrdNO=O.OrdNO and O.Qty=O.DeliQty and ISNULL(O.NoPick,0)=0  ";
            //qry += " group by OrdNo) as DelCount,(select Count(*) from OrdItem O where OrdItem.OrdNO=O.OrdNO and ISNULL(O.NoPick,0)=1 group by OrdNo) as NoPickCount, ";
        ...
        else if (ProjectName.toLowerCase() == "pvm") {
        ...
        success: function (results) {
            ...
            if (ProjectName.toLowerCase() != "pod") {
                ...
                for (var i = 0; i < vehicleData.length; i++) {
                    ...
                    else if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
                        htm = "";
                        //htm += '<tr class="table' + i + '" style="z-index: 0;display:flex;" >'; 
                    ...
                    for (var j = 0; j < selectData.length; j++) {
                        ...
                        if (vehId == selectData[j].VehicleID) {
                            ...
                            else if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
                                //htm += '<tr class="table' + i + '" style="word-break:break-all;z-index: 0;display:flex;" >';
...
function GetVehicleData_old() {
    ...
    for (var i = 0; i < vehicleData.length; i++) {
        ...
        if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
            htm = "";
            htm += '<tr class="table' + i + '" style="z-index: 0;display:flex;" >';
            htm += '<th  style="width: 16%;;">Order No</th>';
            htm += '<th  style="width: 17%;;">City</th>';
        ...
        for (var j = 0; j < selectData.length; j++) {
            if (vehId == selectData[j].VehicleID) {
                ...
                else if (ProjectName.toLowerCase() == "poc" || ProjectName.toLowerCase() == "wms-lsh" || ProjectName.toLowerCase() == "unitrade" || ProjectName.toLowerCase() == "ricwil" || ProjectName.toLowerCase() == "sandl" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
                    // COMMENTED UP AND DOWN MOVEMENT 20.11.2020
                    htm += '<tr class="table' + i + '" style="z-index: 0;display:flex;"  onclick="Row_Click_func(this)"  >';
                    htm += '<td   style="width: 16%;">' + selectData[j].OrdNo + '</td>';
                    htm += '<td   style="width: 35%;">' + selectData[j].CustomerName + '</td>';
...
function PrintPicking(i, vehNo) {
    ...
    if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "pod" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
        window.open(url_WMSLoadPickingReport + "?strPrintPickingInvNo=" + ordNo + "&sRptName=PickingReport")
    }
    else {
        window.open(url_LoadPickingReport + "?strPrintPickingInvNo=" + ordNo + "&sRptName=PickingReport")
...
function PrintPickingConsolidated(i, vehNo) {
    ...
    if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "pod"
        || ProjectName.toLowerCase() == "pvm" || ProjectName.toLowerCase() == "etika" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy")
        // Separate Window
...
function CreateInvoicePOC(ii, vehNo) {
    ...
    if (ProjectName.toLowerCase() == "poc" || ProjectName.toLowerCase() == "wms-lsh" || ProjectName.toLowerCase() == "unitrade" || ProjectName.toLowerCase() == "ricwil" || ProjectName.toLowerCase() == "sandl") {
