...
function GetFormConfig(id, screenName) {
    ...
    if (ProjectName.toUpperCase() == "ETIKA" || ProjectName.toUpperCase() == "PVM" || ProjectName.toUpperCase() == "JSU" || ProjectName.toUpperCase() == "SANDL" || ProjectName.toUpperCase() == "TRADEPROIMPEX") {
                ...
                if (data[i].IsHidden == true) {
                    ...
                    switch (data[i].FieldControl.toLowerCase()) {
                        ...
                        case "textbox":
                            ...
                            if (data[i].DataMemberType == "NUMBER")
                                ...
                                if (ProjectName == "VIDA") {
                                    ...
                                    if (FirstTextBoxautofocus == "")
                                        htm += '<input maxlength="' + maxCharLength + '" type="text" id="' + data[i].DataMember + '" autofocus onclick="formTextFieldFocus(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onblur="formTextFieldLostFocus(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onkeyup="enterformTextFieldLostFocus(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');formTextFieldChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');" placeholder="' + requiredMessage + '"  style="  height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:' + vBackColor + ';font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" />';
                                    else
                                        htm += '<input maxlength="' + maxCharLength + '" type="text" id="' + data[i].DataMember + '" onclick="formTextFieldFocus(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onblur="formTextFieldLostFocus(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onkeyup="enterformTextFieldLostFocus(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');formTextFieldChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');" placeholder="' + requiredMessage + '"  style="  height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:' + vBackColor + ';font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" />';
                                }
                            }
                            htm += '</div>';
                            htm += '</div>';
                        ...
                        case "password":
                            ...
                            htm += '<input type="password" id="' + data[i].DataMember + '" onclick="formTextFieldFocus(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onblur="formTextFieldLostFocus(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onkeyup="formTextFieldChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');" placeholder="' + requiredMessage + '"  style="  height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:' + vBackColor + ';font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';width:94%" />';
                            htm += '<i id="pass-status_' + data[i].DataMember + '" class="fa fa-eye-slash" aria-hidden="true" onclick="viewPassword(\'' + data[i].DataMember + '\')"></i>';
                            htm += '</div>';
                            // }
                            htm += '</div>';
                            htm += '</div>';
                        ...
                        case "listview":
                            ...
                            if (isSearchorSort != 0) {
                                ...
                                htm += '<div id="SortSearchDiv_' + data[i].ScreenName + '_' + data[i].FieldName + '" style="width: 100%;">';
                                //////////////////new
                                htm += '<div id="SortDiv_' + data[i].ScreenName + '_' + data[i].FieldName + '" style="width: 50%; display: inline-block; float: left; margin-top: 0px; margin-right: 0px;display:none">';
                                ...
                                htm += '<div style="width: 20%;  padding-left: 10px; display: inline-block;">';
                                htm += 'Sort : ';
                                htm += '</div>';
                                ...
                                htm += '</div>';
                                htm += '<div id="SortId1_' + data[i].ScreenName + '" style="width: 15%; display: inline-block; ">';
                                ...
                                htm += '<div id="SearchDiv_' + data[i].ScreenName + '_' + data[i].FieldName + '" style="width: 50%; display: inline-block; float: right; margin-top: 0px; margin-right: 0px;">';
                                htm += '<div style="width: 14%; display: inline-block;">';
                                htm += 'Search : ';
                                htm += '</div>';
                                ...
                                htm += '<div id="SearchFieldControlTypeDiv_' + data[i].ScreenName + '" style="width: 8%; display: inline-block;">';
                            ...
                            htm += '<div class="tableDiv_' + CurrentScreen_TabScreen_Name + '_' + data[i].FieldName + '" style="width: ' + data[i].ValueWidth + "%" + '; overflow-x: auto;margin:auto ">';
                    ...
                    if (data[i].IsHidden == true) {
                        ...
                        switch (data[i].FieldControl.toLowerCase()) {
                            ...
                            case "lookup":
                                ...
                                htm += '<div class="input-group" >';
                                htm += '<input type="text" readonly="true"  id="' + data[i].DataMember + '" onfocus = "formLookUpChanged(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"  style="width:100%;height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:' + vBackColor + ';font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';background-color:lightgrey"     placeholder="' + requiredMessage + '" class="form-control"  />';
                                htm += '<span href="#" id="LookUp_' + data[i].DataMember + '"  onchnge = "formLookUpChanged(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"  onclick="formLookUpClicked(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\',\'' + data[i].NewText + '\',\'' + data[i].ScreenName + '\'); " class="input-group-addon"> <i class="fa fa-plus"></i>  </span>';
                                htm += '</div>';
                                htm += '</div>';
                                break;
                            ...
                            case "listview":
                                ...
                                htm += '<div class="tableDiv_' + CurrentScreen_TabScreen_Name + '_' + data[i].FieldName + '" style="width:99%  ; overflow-x: auto; ">';
                                htm += '<table id="table_' + CurrentScreen_TabScreen_Name + '_' + data[i].FieldName + '" class="table table-striped table-bordered tableId">';
                                //  htm += '<table id="table_' + data[i].FieldName + '" class="table table-striped table-bordered tableId">';
                                htm += '<thead id="ListHeadDivId_' + CurrentScreen_TabScreen_Name + '_' + data[i].FieldName + '">';
                                htm += '</thead>';
                            ...
                            case "chart":
                                htm += '<div  class="labeltext" style="width:' + data[i].HeaderWidth + "%" + ';">';
                                htm += '<label  style="height: ' + data[i].HeaderHeight + "px" + ';">' + data[i].NewText + '</label>';
                                htm += '<br>';
                                htm += '<div>';
                            ...
                            case "button":
                                ...
                                htm += '</div>';
                                htm += '<div  class="labeltext" style="width:' + data[i].ValueWidth + "%" + ';">';
                                htm += '<input type="button" id="Button_' + data[i].DataMember + '" value="' + data[i].DefaultText + '"   onclick="formButtonClicked(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"id="' + data[i].DataMember + '" style="width:100%; height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:' + vBackColor + ';font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';line-height:none;" />';
                                htm += '</div>';
                                isBtnFormPopUpTable = true;
                                break;
                        }
...
function formButtonClicked(obj, dataMember, rowIndex, value) {
    ...
    if (currentScreenName == "ModuleSettingsForm" && dataMember == "SaveBtn1") {
        ...
        if (currentScreenName == "InventoryAdjustmentForm1") {//not need
            ...
            var qry = "select InvNo from Invoice where  VehicleID='" + $('#VehicleID').val() + "' and DeliveryDate between '" + fDate + "' and '" + tDate + "'";
            execute(qry);
            ...
            if (strInvNo != "") {
                ...
                // window.location = url_LoadInvoiceReport + "?strInvNo=" + strInvNo + "&sRptName=EverHomeInvoiceRep";
            }
            else {
...
function formFileUploadChange(obj, dataMember, rowIndex, value) {
    ...
    if (obj.accept == "image/*" && (obj.files[0].name.split(".")[1] != "png" && obj.files[0].name.split(".")[1] != "jpg" && obj.files[0].name.split(".")[1] != "jpeg")) {
        $('#' + obj.id).val(null);
        obj = {};
        obj.title = "Error";
...
function listFileUploadChange(obj, dataMember, rowIndex, ttbodyId, tfoot, fieldName) {
...
function formradioButtonValueChanged(obj, dataMember, rowIndex, value) {
    ListSelectedId = [];
    var _obj = {};
    _obj.value = RadioButtonFieldvalue(dataMember);
    _obj.fieldName = dataMember;
