...
function LoadVehicle(data) {
    ...
    if (data != null) {
        for (var i = 0; i < data.length; i++) {
            ...
            if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "pod" || ProjectName.toLowerCase() == "eastocean" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
            ...
            else if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
            ...
            if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy")
            ...
            if (ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
                htm += '<th  style="width: 17%;">City</th>';
            }
            else if (ProjectName.toLowerCase() == "pvm" || ProjectName.toLowerCase() == "dms" || ProjectName.toLowerCase() == "etika" || ProjectName.toLowerCase() == "ffb") {
                htm += '<th  style="width: 17%;">Sales Agent</th>';
            }
            else if (ProjectName.toLowerCase() != "pod"  && ProjectName.toLowerCase() != "sej" && ProjectName.toLowerCase() != "poc" && ProjectName.toLowerCase() != "wms-lsh" && ProjectName.toLowerCase() != "unitrade" && ProjectName.toLowerCase() != "ywf" && ProjectName.toLowerCase() != "ricwil" && ProjectName.toLowerCase() != "sandl") {
            ...
            if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "tradeprofd" || ProjectName.toLowerCase() == "limtraders" || ProjectName.toLowerCase() == "vismark") {
                if (ProjectName.toLowerCase() != "sej") htm += '<th  style="width: 6%;">VehicleID</th>';
            ...
            if (ProjectName.toLowerCase() != "poc" && ProjectName.toLowerCase() != "wms-lsh" && ProjectName.toLowerCase() != "unitrade" && ProjectName.toLowerCase() != "ywf" && ProjectName.toLowerCase() != "ricwil"
                && ProjectName.toLowerCase() != "sandl" && ProjectName.toLowerCase() != "laponie" && ProjectName.toLowerCase() != "frostfood" && ProjectName.toLowerCase() != "wms" && ProjectName.toLowerCase() != "sej") {
            ...
            if ((ProjectName.toLowerCase() != "pvm" && ProjectName.toLowerCase() != "dms" && ProjectName.toLowerCase() != "ffb" && ProjectName.toLowerCase() != "wms" && ProjectName.toLowerCase() != "sej" && ProjectName.toLowerCase() != "laponie" && ProjectName.toLowerCase() != "frostfood"  && ProjectName.toLowerCase() != "wil" && ProjectName.toLowerCase() != "leonsynergy") || ProjectName.toLowerCase() == "etika") {
                htm += '<th  style="width: 18%;">Cubage</th>';
            }
            ...
            if (ProjectName.toLowerCase() != "laponie" && ProjectName.toLowerCase() != "frostfood")
...
function GetVehicleData() {
    ...
    else if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "pod" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
        UpdateOrderVehicle();
    }
    ...
    if (ProjectName.toLowerCase() != "jsu") {
        ...
        else if (ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" ) {
            ...
            if (executeQry != null) {
                if (ProjectName.toLowerCase() != "pod" ) {
                    ...
                    for (var i = 0; i < vehicleData.length; i++) {
                        ...
                        if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
...
function GetVehicleData_old() {
    ...
    for (var i = 0; i < vehicleData.length; i++) {
        ...
        if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
            htm = "";
            htm += '<tr class="table' + i + '" style="z-index: 0;display:flex;" >';
            htm += '<th  style="width: 16%;;">Order No</th>';
            htm += '<th  style="width: 17%;;">City</th>';
...
function PrintPicking(i, vehNo) {
    ...
    if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "pod" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
        window.open(url_WMSLoadPickingReport + "?strPrintPickingInvNo=" + ordNo + "&sRptName=PickingReport")
    }
    else {
        window.open(url_LoadPickingReport + "?strPrintPickingInvNo=" + ordNo + "&sRptName=PickingReport")
...
function PrintPickingConsolidated(i, vehNo) {
    ...
    if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "pod"
