...
function AssignMultiListData() {
    ...
    if (currentScreenName == "SalesOrderNewForm1") {
        ...
        setTimeout(function () {
            ...
            //tableTotalRowCount = $('#table_' + CurrentScreen_TabScreen_Name + '_' + FieldName.split('_')[0] + ' >tbody >tr').length;
            dynamicRowindex = tableTotalRowCount;
            //dynamicRowindex = (currentRowClickCount - 1);
            // debugger;
            ...
            if (ProjectName.toLowerCase() == 'fgv' && (currentScreenName == 'PromotionGroupNewForm' || currentScreenName == 'PromotionGroupForm'))
                _listLookUpIndex = len - 3;
