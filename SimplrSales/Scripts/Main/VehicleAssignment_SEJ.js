//view using format:
//use SimplrLimTraders//select * from[VehicleAssignment_LoadVehicle]//select * from VehicleAssignment_OrderLoad where deliverydate between '" + deliverydate + " 00:00:00 " + "' and '" + deliverydate + " 23:59:59 " + "'
