...
function FFB_Reallocate(i,vehicleCode) {

    try {
        var DeliveryDt = '';
        DeliveryDt = $('#DeliveryDate').val();
        ...
        if (DeliveryDt == '') {
            ...
            _LoadingImageOpen();
            setTimeout(function () {
                var deliverydateffb = DateFormateChange_Format(_format, $('#DeliveryDate').val());
                var clr = $('#printbtnbackRoundColor' + i).css('background-color');
                if (clr == 'rgb(255, 0, 0)') {
                    qry = "exec [VehicleAssignment_ReallocateProc] '" + deliverydateffb + "','" + vehicleCode + "'";
                    execute(qry);
                    showAlertMessage("Reallocate", "Reallocated Successfully!");
                    GetVehicleData();
                }
                else
                    showAlertMessage("Reallocate", "The vehicle you are trying to reallocate is within its load limit and does not require reallocation.!");
...
function GetVehicleList_sub() {
    ...
    else if ( ProjectName.toLowerCase() == "pegasus" ||
    ...
    else if (ProjectName.toLowerCase() == "limtraders" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "selasihaman" || ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard" || ProjectName.toLowerCase() == "vismark" || ProjectName.toLowerCase() == "wms") {
...
function LoadVehicle(data) {
    ...
    if (data != null) {
        for (var i = 0; i < data.length; i++) {
            ...
            else if (ProjectName.toLowerCase() == "ffb" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh")
            ...
            //w3-black
            if (ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh")
            ...
            if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "pod" || ProjectName.toLowerCase() == "eastocean" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
                ...
                htm += '<a   onclick="CreateManifest(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button">Create Assignment</a>';
            }
            else if (ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "ffb" || ProjectName.toLowerCase() == "lsh") {
            ...
            //        htm += '<a   onclick="CreateManifest(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button">Create Manifest</a>';
            //}
            else if (ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard") {
                if (data[i].Code.toLowerCase() != "buffer")
                    htm += '<a   onclick="CreateManifest(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button">Create Manifest</a>';
            }
            ...
            if (ProjectName.toLowerCase() == "ffb") {
                if (data[i].Code.toLowerCase() != "buffer")
                htm += '<a   onclick="FFB_Reallocate(' + i + ',\'' + data[i].Code + '\');" class="w3-bar-item w3-button">Reallocate</a>';
            }
            ...
            else if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy" || ProjectName.toLowerCase() == "lsh") {
                htm += ' <span style="margin-left:5px;font-size:13px;font-weight:bold;color:white;" id="div' + i + '_ltotqty">' + data[i].Description.substring(0, 50) + " - " + "TOTAL QTY :  " + '</span> <span style="font-size:13px;font-weight:bold;color:white;" id="div' + i + '_totqty"></span>';
            }
            else if (ProjectName.toLowerCase() == "ffb")
            {
            ...
            else if (ProjectName.toLowerCase() != "pod" && ProjectName.toLowerCase() != "sej" && ProjectName.toLowerCase() == "lsh" && ProjectName.toLowerCase() != "ffb" && ProjectName.toLowerCase() != "eonmetall" && ProjectName.toLowerCase() != "selasihaman" && ProjectName.toLowerCase() != "ofii" && ProjectName.toLowerCase() != "standard" && ProjectName.toLowerCase() != "poc" && ProjectName.toLowerCase() != "wms-lsh" && ProjectName.toLowerCase() != "unitrade" && ProjectName.toLowerCase() != "ywf" && ProjectName.toLowerCase() != "ricwil" && ProjectName.toLowerCase() != "sandl") {
            ...
            if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "selasihaman" || ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard" || ProjectName.toLowerCase() == "laponie"  || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "tradeprofd" || ProjectName.toLowerCase() == "limtraders" || ProjectName.toLowerCase() == "vismark") {
                if (ProjectName.toLowerCase() != "sej" && ProjectName.toLowerCase() != "lsh" && ProjectName.toLowerCase() != "ffb" && ProjectName.toLowerCase() != "selasihaman" && ProjectName.toLowerCase() != "ofii" && ProjectName.toLowerCase() != "eonmetall" && ProjectName.toLowerCase() != "standard") htm += '<th  style="width: 6%;">VehicleID</th>';
            ...
            if (ProjectName.toLowerCase() != "poc" && ProjectName.toLowerCase() != "wms-lsh" && ProjectName.toLowerCase() != "unitrade" && ProjectName.toLowerCase() != "ywf" && ProjectName.toLowerCase() != "ricwil"
                && ProjectName.toLowerCase() != "sandl" && ProjectName.toLowerCase() != "laponie" && ProjectName.toLowerCase() != "wms" && ProjectName.toLowerCase() != "sej" && ProjectName.toLowerCase() != "lsh" && ProjectName.toLowerCase() != "ffb" && ProjectName.toLowerCase() != "selasihaman" && ProjectName.toLowerCase() != "ofii" && ProjectName.toLowerCase() != "eonmetall" && ProjectName.toLowerCase() != "standard" && ProjectName.toLowerCase() != "frostfood") {
            ...
            if ((ProjectName.toLowerCase() != "pvm" && ProjectName.toLowerCase() != "frostfood" && ProjectName.toLowerCase() != "dms" && ProjectName.toLowerCase() != "ffb" && ProjectName.toLowerCase() != "wms" && ProjectName.toLowerCase() != "sej" && ProjectName.toLowerCase() != "lsh" && ProjectName.toLowerCase() != "selasihaman" && ProjectName.toLowerCase() != "ofii" && ProjectName.toLowerCase() != "eonmetall" && ProjectName.toLowerCase() != "standard" && ProjectName.toLowerCase() != "laponie"   && ProjectName.toLowerCase() != "wil" && ProjectName.toLowerCase() != "leonsynergy") || ProjectName.toLowerCase() == "etika") {
                htm += '<th  style="width: 18%;">Cubage</th>';
            }
            ...
            if (ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard") {
...
function GetVehicleData() {
    ...
    else if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "ffb" || ProjectName.toLowerCase() == "selasihaman" || ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard" || ProjectName.toLowerCase() == "laponie"  || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "pod" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
        UpdateOrderVehicle();
    }
    ...
    if (ProjectName.toLowerCase() != "jsu") {
        ...
        else if (ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "wms") {
    ...
    $.ajax({
        ...
        success: function (results) {
            ...
            if (executeQry != null) {
                if (ProjectName.toLowerCase() != "pod" ) {
                    ...
                    for (var i = 0; i < vehicleData.length; i++) {
                        ...
                        if (ProjectName.toLowerCase() == "wms-warehouse") {// || ProjectName.toLowerCase() == "lsh") {
                        ...
                        else if (ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh") {
                            ...
                            try {
                                ...
                                if (dbDataRows1.length == 0 || dbDataRows1 == null ) {
                                    ...
                                    if (vehicleData[i].Color.toLowerCase() == "yellow") {
                                        $('#vehDesc' + i).css('color', 'black');
                                        $('#printbtnbackRoundColor' + i).css('color', 'black');
                                    }
                                    else {
                                        $('#vehDesc' + i).css('color', 'white');
                                        $('#printbtnbackRoundColor' + i).css('color', 'white');
                                    }
                                    ...
                                    if (tmpObj.Color.toLowerCase() == "yellow") {
                                        $('#vehDesc' + i).css('color', 'black');
                                        $('#printbtnbackRoundColor' + i).css('color', 'black');
                                    }
                                    else {
                        ...
                        else if (ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall") {
                            htm = "";
                            //htm += '<tr class="table' + i + '" style="z-index: 0;display:flex;" >'; 
                            //htm += '<tr class="table' + i + '" style="z-index: 0;display:inherit;" >';
                            htm += '<tr class="table' + i + '"  >';
                        ...
                        else if (ProjectName.toLowerCase() == "standard") {
                            htm = "";
                            //htm += '<tr class="table' + i + '" style="z-index: 0;display:flex;" >'; 
                            //htm += '<tr class="table' + i + '" style="z-index: 0;display:inherit;" >';
                            htm += '<tr class="table' + i + '"  >';
                        ...
                        for (var j = 0; j < selectData.length; j++) {
                            ...
                            if (vehId.toLowerCase() == selectData[j].VehicleID.toLowerCase()) {
                                ...
                                else if (ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "standard" || ProjectName.toLowerCase() == "eonmetall") {
                        ...
                        if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "ffb" || ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy" ) {
                            var info = _totQty + " - No of Order(s) : " + _totnoofOrders + "";
                            $("#div" + i + "_totqty").text(info);
                            _totQty = 0;
                            _totnoofOrders = 0;
                        ...
                        GetOrdNo(i, vehId);
                        if (ProjectName.toLowerCase() != "ffb" && ProjectName.toLowerCase() != "sej" && ProjectName.toLowerCase() != "wms") {
                            if (ordNo != "") {
                                if (ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "selasihaman" || ProjectName.toLowerCase() == "wms") {
            ...
            if (ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "ffb" || ProjectName.toLowerCase() == "selasihaman" || ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard")
...
function GetVehicleData_old() {
    ...
    for (var i = 0; i < vehicleData.length; i++) {
        ...
        if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "ffb" || ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard" || ProjectName.toLowerCase() == "laponie"  || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
            htm = "";
            htm += '<tr class="table' + i + '" style="z-index: 0;display:flex;" >';
            htm += '<th  style="width: 16%;;">Order No</th>';
            htm += '<th  style="width: 17%;;">City</th>';
...
function CalculateVehicles(i, ordNo, vehLength, vehHeight, vehWidth) {
    ...
    $.ajax({
        ...
        success: function (results) {
            if (results == "Yellow") {
                $('#printbtnbackRoundColor' + i).css('color', 'Black');
                $('#divbackRoundColor' + i).css('color', 'Black');
                $('#div' + i + '_totqty').css('color', 'Black');
                $('#div' + i + '_ltotqty').css('color', 'Black');
            }
            else {
                $('#printbtnbackRoundColor' + i).css('color', 'White');
                $('#divbackRoundColor' + i).css('color', 'White');
                $('#div' + i + '_totqty').css('color', 'White');
                $('#div' + i + '_ltotqty').css('color', 'White');
            }
...
function PrintPicking(i, vehNo) {
    ...
    if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "selasihaman" || ProjectName.toLowerCase() == "laponie"  || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "pod" || ProjectName.toLowerCase() == "wil" || ProjectName.toLowerCase() == "leonsynergy") {
        window.open(url_WMSLoadPickingReport + "?strPrintPickingInvNo=" + ordNo + "&sRptName=PickingReport")
    }
    else {
        window.open(url_LoadPickingReport + "?strPrintPickingInvNo=" + ordNo + "&sRptName=PickingReport")
...
function PrintPickingConsolidated(i, vehNo) {
    ...
    if (ProjectName.toLowerCase() == "wms" || ProjectName.toLowerCase() == "sej" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "ffb" || ProjectName.toLowerCase() == "selasihaman" || ProjectName.toLowerCase() == "ofii" || ProjectName.toLowerCase() == "eonmetall" || ProjectName.toLowerCase() == "standard" || ProjectName.toLowerCase() == "laponie" || ProjectName.toLowerCase() == "frostfood" || ProjectName.toLowerCase() == "wms-warehouse" || ProjectName.toLowerCase() == "lsh" || ProjectName.toLowerCase() == "pod"
...
function CreateManifest(ii, vehNo) {
    ...
    for (i = 1; i < myTab.rows.length; i++) {
        ...
        for (var j = 0; j < 1; j++) {
            ...
            if (ProjectName.toLowerCase() == "frostfood") {
                ...
                ArrDoc.delidtfrom = DateFormateChange_Format(_format, document.getElementById('DeliveryDateFrom').value);
                ArrDoc.delidtto = DateFormateChange_Format(_format, document.getElementById('DeliveryDateTo').value);
                ArrDoc.manifestdt = DateFormateChange_Format(_format, document.getElementById('ManifestDate').value);
            }
            else
                ArrDoc.delidt = DateFormateChange_Format(_format, $('#DeliveryDate').val());//DateFormateChange($('#DeliveryDate').val());
    ...
    if (ProjectName.toLowerCase() == "frostfood") {
        // var url_GetCreateManifest1 = '@Url.Content("~/VehicleAssignment/GetCreateManifestFrostfood/")';
        $.ajax({
            url: url_GetCreateManifest1,
            type: 'POST',
...
function AssignOrder() {
    ...
    MoveOrder($("#VehicleId option:selected").text(), $('#txtOrdNo').val(), "1");
}
...
function BulkAssignOrder() {
    var vehicleId = $("#VehicleId option:selected").text(); //$('#VehicleId1').val();
    if (vehicleId == "") {
        var btns = {};
        btns["Ok"] = function (e) {
            $(this).dialog("close");
