            ...
            if (status == google.maps.DirectionsStatus.OK) {
                ...
                for (i = 0; i < legs.length; i++) {
                    if (i == 0) {
                        ...
                        marker[routeNum] = createMarker(legs[i].start_location, arrLocData[dPinIndex].MarkerNo, legs[i].start_address, arrLocData[dPinIndex].Color, 1);
                    ...
                    if (routeNum == (arrLoc.length - 2)) {
                        ...
                        //marker[routeNum] = createMarker(legs[i].start_location, "start", legs[i].start_address, "green", 1);
                        marker[routeNum] = createMarker(legs[i].start_location, arrLocData[dPinIndex + 1].MarkerNo, legs[i].start_address, arrLocData[dPinIndex + 1].Color, 1);
                    }
                    else {
                        //marker[routeNum] = createMarker(legs[i].start_location, "start", legs[i].start_address, "green", 0);
                        marker[routeNum] = createMarker(legs[i].start_location, arrLocData[dPinIndex].MarkerNo, legs[i].start_address, arrLocData[dPinIndex].Color, 0);
                    }
                    //if (arrLoc.length == 1) {
                    //    endLocation[routeNum].latlng = legs[i].end_location;
                    //    endLocation[routeNum].address = legs[i].end_address;
