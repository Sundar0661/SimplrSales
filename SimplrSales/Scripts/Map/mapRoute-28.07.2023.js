            ...
            if (status == google.maps.DirectionsStatus.OK) {
                ...
                for (i = 0; i < legs.length; i++) {
                    if (i == 0) {
                        ...
                        marker[routeNum] = createMarker(legs[i].start_location, arrLocData[i].MarkerNo, legs[i].start_address, arrLocData[i].Color, 1);
                    }
                    ...
                    if (routeNum == (arrLoc.length - 2)) {
                        ...
                        marker[routeNum] = createMarker(legs[i].start_location, arrLocData[i].MarkerNo, legs[i].start_address, arrLocData[i].Color, 0);
                    }
