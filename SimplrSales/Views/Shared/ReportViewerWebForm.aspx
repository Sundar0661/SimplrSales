...
<head runat="server">
    ...
    <%--// Finished--%>
     ...
     <script type="text/javascript">
         ...
         //Added by Sundar 20/11/2022
         //Added by Sundar 25/11/2022
         $(document).ready(function () {
             debugger;
             // alert("ENTERED");
             $(".msrs-printdialog-pprintbutton").on('click', function () {

                 var reportName = $('#<%=HdnreportName.ClientID%>').val();

                 // alert(reportName);
                 var url_UpdateOrderData = '@Url.Content("~/Reports/updateOrderDet/")';
    ...
    @"<DeviceInfo>
        ...
        private void LoadReport()
        {
           ...
           if (ds.Tables[1].Rows.Count > 0)            {                ReportName = ds.Tables[1].Rows[0]["ReportName"].ToString();                 //Changed by Sundar 20/11/2022                HdnreportName.Value = ReportName.ToString();            }
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="width: 99%; overflow-x: scroll">
            ...
            <p id="hdnOrdersNo" runnut="server" style="visibility: hidden"></p>
            <%--<input type="hidden" name="HdnreportName" id="HdnreportName" >--%>
            <%--Finished--%>
