...
{
    public class ReportsOldController : Controller
    {
        ...
        public ActionResult ReportView1(string InitReport, string ReportName, string LoadReport)
        {
        ...
        public JsonResult GETADDRESS(string date, string SalesmanTerritory)
        {
            ...
            try
            {
                ...
                for (i = 0; i <= 3; i++)
                {
                    // LOOP HOLES FOUND HERE DID NOT CLOSE CONNECTION HERE...
                    // [OR] HAVE TO USE using BLOCK
                    SqlConnection con = new SqlConnection(constr);
        ...
        // LOOP HOLES HERE THIS FUNCTION DID NOT USED ANYWHERE ========
        ...
        public string GetPoint(string Latitude, string Longitude)
        {
            ...
            {
                doc.Load("https://maps.googleapis.com/maps/api/geocode/xml?key=AIzaSyA8ZjDFQ3cEwcqfsTUhlN3JbKShfD_KKKM&latlng=" + Latitude + "," + Longitude + "&sensor=false");
            }
        ...
        public JsonResult GETDISTANCE(string date, string SalesmanTerritory)
        {
            ...
            try
            {
                ...
                while (dtr.Read() == true)
                {
                    ...
                    if (dtr["TransType"].ToString() == "CLOCK-OUT")
                    {
                        ...
                        try
                        {
                            ...
                            SqlCommand com1 = new SqlCommand("Update ActivityRep Set Amt=" + dInTimeSent + " where CustID=" + dtr["CustID"].ToString() + " and TransDate=" + dtr["TransDate"].ToString() + " and TransType='CLOCK-OUT'", con);
                ...
                while (dtr.Read())
                {
                    ...
                    SqlCommand com1 = new SqlCommand("Update ActivityRep set Packer=" + Deviation + " Where CustID=" + dtr["CustID"].ToString() + "  and TransNo=" + dtr["TransNo"].ToString(), con);
                    com1.ExecuteNonQuery();
                }
                dtr.Close();
                return Json(1);
        ...
        public void FTPDownloadFile(string downloadpath, string ftpuri, string Img)
        {
            ...
            try
            {
                ...
                // LOOPHOLES FOUND HERE HAVE TO DISPOSE - DownloadStream.Dispose()
        ...
        public JsonResult LOADSERVICE(string fromdate, string todate, string salesmanterritory, string userid, string servicetype, string reasoncode)
        {
            ...
            // LOOP HOLES HERE DID NOT CLOSE THE CONNECTION 
                ...
                while (dtr.Read() == true)
                {
                    ...
                    if (arrFo.Length > 0)
                    {
                        for (int i = 0; i < arrFo.Length; i++)
                        {
                            ...
                            // LOOP HOLES FOUND AND RE-CORRECTED BY BELOW CODE SEGMENT
            ...
            try
            {
                ...
                while (dtr.Read() == true)
                {
                    ...
                    else
                    {
                        ...
                        // LOOP HOLES HERE 
                        // HERE DID NOT USE DISPOSE METHOD BELOW OBJECTS
                        // Bitmap, MemoryStream
                        Bitmap bm = new Bitmap(imageProduct, iWidth, iHeight);
                        Bitmap bm1 = new Bitmap(imageProduct1, iWidth1, iHeight1);
                        MemoryStream ms = new MemoryStream();
        ...
        public JsonResult LOADMETERREADING(string fromdate, string todate, string salesmanterritory, string userid)
        {
            ...
            try
            {
                ...
                // HAVE TO WRITE HERE AS LIKE BELOW ================================
                //  step 1:
                //  if (dtr != null) dtr.Dispose();

                //  step 2:
                //  if (com1 != null) com1.Dispose();
