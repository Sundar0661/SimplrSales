            ...
            if (isBtnFormPopUpTable == false || listConfig[j].DataMember.replace("\t", "").toLowerCase() != 'action') {
                ...
                switch (fieldControl.toLowerCase()) {
                        ...
                        if (listConfig[j].DataMemberType == "NUMBER") {
                            ...
                            if (ProjectName.toLowerCase() == "sengchoon" && (scrName == "InvoiceNewForm" || scrName == "InvoiceForm") && listConfig[j].DataMember == "Qty")
                                ...
                                if (isReadOnly == true || isDisable == true)
                                    htm += '<input   type="text" maxlength="' + maxCharLength + '" data-restrict="1234567890:" placeholder="' + requiredMessage + '"  style="z-index: 99;cursor:not-allowed" id="' + listConfig[j].DataMember + '" name="' + listConfig[j].DataMember + '" value=""  onkeypress="restrictMinus(event);" onclick="listTextFieldFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');"onblur="listTextFieldLostFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');"onkeyup="listTextFieldChange(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');" disabled />';
                                else
                                    htm += '<input   type="text" maxlength="' + maxCharLength + '" data-restrict="1234567890:" placeholder="' + requiredMessage + '"  style="z-index: 99;cursor:' + cursorType + '" id="' + listConfig[j].DataMember + '" name="' + listConfig[j].DataMember + '" value=""  onkeypress="restrictMinus(event);listNumberTextFieldFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\')" onclick="listTextFieldFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');"onblur="listTextFieldLostFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');"onkeyup="listTextFieldChange(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');" />';
                            }
                        }
                            ...
                            if (isReadOnly == true || isDisable == true)
                                htm += '<input   class="int" type="text" maxlength="' + maxCharLength + '" style="z-index: 99;cursor:' + cursorType + '" id="' + listConfig[j].DataMember + '" value="" oncopy="return false" onpaste="return false" onkeypress="restrictMinusDot(event);" onclick="listTextFieldFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');"onblur="listTextFieldLostFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');"onkeyup="listTextFieldChange(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');" disabled />';
                            else
                                htm += '<input   class="int" type="text" maxlength="' + maxCharLength + '" style="z-index: 99;cursor:' + cursorType + '" id="' + listConfig[j].DataMember + '" value="" oncopy="return false" onpaste="return false" onkeypress="restrictMinusDot(event);" onclick="listTextFieldFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');"onblur="listTextFieldLostFocus(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');"onkeyup="listTextFieldChange(this,\'' + listConfig[j].DataMember + '\',' + addCount + ',' + $(this).parent().index('td') + ',\'' + fieldName + '\',\'' + ttbody + '\',\'' + tfoot + '\');" />';
                    ...
                    case "showimage":
                        ...
                        htm += '<img type="image"  src=""  id="' + listConfig[j].DataMember + '"   style="width:84%;height:' + listConfig[j].RowHeight + 'px;float:left;border-radius:0px;" ></img>';
