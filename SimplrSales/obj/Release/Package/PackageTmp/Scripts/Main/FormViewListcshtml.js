   ...
   // alert("TestVishnu");
    ...
    try {
        ...
        else if (ProjectName == "FGV" && _screenName == "Web_DashBoard_01") 
        {
            ...
            var htmm = '<div style="position:absolute;height:500px;width:100%;">';
            htmm += '<img src="../Images/EB_Logo-New.png" style="position:absolute;opacity:0.5;height:400px;top:0;bottom:0;left:0;right:0;margin:auto;" />';
            htmm += '</div>';

            $("#FormListDivId").append(htmm)

            //document.getElementById("FormListDivId").append(htmm);
            document.getElementById("formContainer").style = "height:500px;background-color:lightyellow;";
            document.getElementById("FormListDivId").style = "display:none;height:100%";
        }
    } catch (err1) {
