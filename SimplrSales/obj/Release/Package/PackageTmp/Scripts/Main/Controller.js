...
function windowPreparingToOpen(currentScreenName) {
    ...
    try {
        ...
        //var qry = "SELECT * FROM ActionConfig WHERE ScreenName='" + currentScreenName + "'  ORDER By ActionName, DisplayNo";
         var qry = "SELECT * FROM ActionConfig WHERE ScreenName='" + currentScreenName + "'  ORDER By  DisplayNo";
                    ...
                    if (arrActionQuery[i].ActionType.toUpperCase() == "EXECUTE") {
                     ...
                     //       handleFieldAction(currentScreenName, objData.fieldName, arrActionQuery[i].Action);
                      //  else
                        ...
                        // alert("hidden_check");
                        var _qry = "Select * from hiddenconfig where screenname like '" + arrActionQuery[i].ScreenName + "' order by priorityseq";
                        execute(_qry);
                        ...
                        _qry = "select mc.ScreenName,mc.FieldName,fc.FieldControl,mc.ConditionField,mc.ConditionValue from mandatorylistconfig mc,listconfig fc where   mc.fieldname like fc.fieldname and mc.ismandatory=1 and mc.solutionname like '" + SolutionName + "' and (fc.screenname like (mc.screenname + '%')) and mc.screenname like '" + arrActionQuery[i].ScreenName + "%' order by mc.priorityseq;";
                        execute(_qry);
                        dbDataRows1 = executeQry;
                        //dbDataRows = dbDataRows;
                        var tmpFlag = false;
                                    ...
                                    if (obj["FieldControl"] == "LISTVIEW") {
                                        ...
                                        for (var h = 0; h <= dbDataRows2.length - 1; h++) {
                                            ...
                                            for (var k = 0; k <= row_count - 1; k++) {
                                                ...
                                                // if (tblbody.rows[k].cells.namedItem(obj2["FieldName"]).childNodes['0'].nodeName == 'DIV' && obj2["FieldControl"] == 'DATEPICKER') {
                                                //// if (ProjectName.toLowerCase() == "cpf" && obj2["FieldControl"] == 'DATEPICKER') {
                                                //     try {
                                                //         if (chk == undefined || chk == '')
                                                //             chk = tblbody.rows[k].cells.namedItem(obj2["FieldName"]).childNodes['0'].childNodes['0'].value;
                                                //     } catch (e) {
