                            ...
                            if (ProjectName == "CPF") {
                               // if (data[i].AutoFocus == null || data[i].AutoFocus == 0) {
                                if (vBackColor == '#ffffff') {
                                    ...
                                    if (data[i].TabIndex == null)
                                        htm += '<select id="' + data[i].DataMember + '" onchange="formComboChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\'); DropDownOnchangeFunction(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onclick="comboBoxFormItemClicked(\'' + "" + '\',0,\'' + $('#' + data[i].DataMember).val() + '\',\'' + $('#' + data[i].DataMember).val() + '\',\'' + data[i].ScreenName + '\',\'' + data[i].FieldName + '\',\'' + "" + '\', \'' + data[i].DataMember + '\');" style="  height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:#f0f0f0;font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" >';
                                    else
                                        htm += '<select id="' + data[i].DataMember + '" TabIndex=' + data[i].TabIndex + ' onchange="formComboChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\'); DropDownOnchangeFunction(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onclick="comboBoxFormItemClicked(\'' + "" + '\',0,\'' + $('#' + data[i].DataMember).val() + '\',\'' + $('#' + data[i].DataMember).val() + '\',\'' + data[i].ScreenName + '\',\'' + data[i].FieldName + '\',\'' + "" + '\', \'' + data[i].DataMember + '\');" style="  height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:#f0f0f0;font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" >';
                                    ...
                                    if (data[i].TabIndex == null)
                                        ...
                                        htm += '<select id="' + data[i].DataMember + '" TabIndex=' + data[i].TabIndex + ' onchange="formComboChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\'); DropDownOnchangeFunction(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');"onclick="comboBoxFormItemClicked(\'' + "" + '\',0,\'' + $('#' + data[i].DataMember).val() + '\',\'' + $('#' + data[i].DataMember).val() + '\',\'' + data[i].ScreenName + '\',\'' + data[i].FieldName + '\',\'' + "" + '\', \'' + data[i].DataMember + '\');" style="  height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:' + vBackColor + ';font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" >';
                            ...
                            case "combobox":
                                ...
                                if (ProjectName == "CPF") {
                                    if (vBackColor == '#ffffff') {
                                        // if (data[i].AutoFocus == null || data[i].AutoFocus == 0) {
                                        if (data[i].TabIndex == null)
                                            htm += '<select id="' + data[i].DataMember + '" onchange="formComboChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');DropDownOnchangeFunction(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');comboBoxFormItemClicked(\'' + "" + '\',0,\'' + $('#' + data[i].DataMember).val() + '\',\'' + $('#' + data[i].DataMember).val() + '\',\'' + data[i].ScreenName + '\',\'' + data[i].FieldName + '\',\'' + "" + '\', \'' + data[i].DataMember + '\');"  style="height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:#f0f0f0;font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" >';
                                        else
                                            htm += '<select id="' + data[i].DataMember + '" TabIndex=' + data[i].TabIndex + ' onchange="formComboChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');DropDownOnchangeFunction(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');comboBoxFormItemClicked(\'' + "" + '\',0,\'' + $('#' + data[i].DataMember).val() + '\',\'' + $('#' + data[i].DataMember).val() + '\',\'' + data[i].ScreenName + '\',\'' + data[i].FieldName + '\',\'' + "" + '\', \'' + data[i].DataMember + '\');"  style="height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:#f0f0f0;font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" >';
                                        //}
                                        //else
                                        ...
                                        if (data[i].TabIndex == null)
                                            htm += '<select id="' + data[i].DataMember + '" onchange="formComboChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');DropDownOnchangeFunction(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');comboBoxFormItemClicked(\'' + "" + '\',0,\'' + $('#' + data[i].DataMember).val() + '\',\'' + $('#' + data[i].DataMember).val() + '\',\'' + data[i].ScreenName + '\',\'' + data[i].FieldName + '\',\'' + "" + '\', \'' + data[i].DataMember + '\');"  style="height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:' + vBackColor + ';font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" >';
                                        else
                                            htm += '<select id="' + data[i].DataMember + '" TabIndex=' + data[i].TabIndex + ' onchange="formComboChange(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');DropDownOnchangeFunction(this,\'' + data[i].DataMember + '\',' + i + ',\'' + $('#' + data[i].DataMember).val() + '\');comboBoxFormItemClicked(\'' + "" + '\',0,\'' + $('#' + data[i].DataMember).val() + '\',\'' + $('#' + data[i].DataMember).val() + '\',\'' + data[i].ScreenName + '\',\'' + data[i].FieldName + '\',\'' + "" + '\', \'' + data[i].DataMember + '\');"  style="height: ' + data[i].ValueHeight + "px" + ';font-size:' + data[i].VFontSize + "px" + ';color:' + vForeColor + ';background-color:' + vBackColor + ';font-family:' + data[i].VFont + ';text-align:' + getAlignStyle(data[i].VAlignment) + ';" >';
...
function listTextFieldChange(obj, dataMember, rowIndex, value, fieldName) {
...
function listCheckBoxValueChanged(obj, dataMember, rowIndex, value, ttbodyId, tfoot, fieldName) {
    ...
    try {
        if ((ProjectName == "CPF" || ProjectName == "FGV" || ProjectName == "EBFF") && currentScreenName.toLowerCase() == "paymentscollectionnewform" && dataMember == "AmtChk") {
