...
function showAlertMessage_survey(obj, messageHeader) {
    ...
    btns["Ok"] = function (e) {
        ...
        if (obj.title == "InBound Updation") {
            ...
            if (obj.message == 'Failed. please check.' || obj.message == 'Saved Successfully.') {
                //alert('eee');
...
function ActiveSurvey_Save(Data, Id) {
    //debugger;
    var qry;
    qry = "";
    qry = " Update a set  Active= '" + Id + "' from POSTheme a where upper(ThemeName) = upper('" + Data + "') ";
    execute(qry)
    var obj = {};
    obj.title = "Information";
