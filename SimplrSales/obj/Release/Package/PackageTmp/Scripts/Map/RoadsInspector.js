...
//<!-- COMMENTED AIzaSyC5XH-ALvr81IiuEDWekI2k91ujPeZL864 -->
// Replace with your own API key
//var API_KEY = 'AIzaSyC5XH-ALvr81IiuEDWekI2k91ujPeZL864';//'YOUR_API_KEY';
...
var SPEED_LIMIT_URL = 'https://roads.googleapis.com/v1/speedLimits?key=' + API_KEY;
...
var eg1q = '-33.870315,151.196532|-33.869979,151.197355|' +
...
var eg1d = '-33.870315,151.196532|' +
   '-33.872031,151.198413';
//-33.870315,151.196532|-33.872031,151.198413
//11.0176,76.9674|11.0217,76.9722
var eg1s = '11.0176,76.9674|11.0217,76.9722';
//'11.0802,76.9415';
  
var eg31 = '11.0168° N,76.9558° E|' +
      '11.2321° N,7.1067° E|11.5034° N,77.2444° E';

var eg321 = '11.0168,76.9558|' +
      '11.2321,7.1067|11.5034,77.2444';
...
function initialize() {
    $('#eg1').click(function (e) {
        ...
        for (var i = 0; i < arr.length; i++) {
            if (i == (arr.length - 1))
                fff += arr[i].Latitude + "," + arr[i].Longitude;
            else
                fff += arr[i].Latitude + "," + arr[i].Longitude + "|";
        }
        //debugger;
    ...
    function bendAndSnap() {
        ...
        //   coords = parseCoordsFromQuery(fff);
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#requestURL').html('<a target="blank" hre' + 'f="' +
                ...
                for (var i = 0; i < data.snappedPoints.length; i++) {
                    ...
                    setTimeout(function () {
                        ...
                        if (j == i) {
                            ...
                            //processSnapToRoadResponse(data, j);
                            ...
                            if (j != (i - 1)) {
                                //   if (j ==0) {
                                processSnapToRoadResponse(data, j + 1);
                                drawSnappedPolyline(snappedCoordinates);
                                drawOriginals(originals);
                                fitBounds(markers);
                            }
            ...
            error: function () {
                $('#requestURL').html('<strong>That query didn\'t work :(</strong>' +
                    '<p>Try looking at the <a target="blank" hre' + 'f="' + this.url +
                    '">Request URL</a></p>');
                clearMap();
            }
        });
    ...
    function processSnapToRoadResponse(data, j) {
        //debugger;
        var originalIndexes = [];
        ...
        for (var i = (j - 1) ; i <= j; i++) {
            ...
            //if (i > 0 && i < data.snappedPoints.length - 1) {
            //}
            //else {
...
function animateCircle(polyline) {
    ...
    var timer1 = window.setInterval(function () {
        ...
        var icons = polyline.get('icons') || defaultIcon;
        $('#cnt1').val(icons[0].offset); $('#cnt2').val((count / 2) + '%');
