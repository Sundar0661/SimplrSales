//function initMap() {
function initMapWaypointsDirections() {

    getWaypointsDirectionsLatLonValue();
...
function getWaypointsDirectionsLatLonValue(action) {
    if (action == undefined) {
        ...
        //qry = "SELECT  '1' as MarkerNo, 'T19-100025544' as CustNo,'PIN' as ICON ,'red' as Color, 'T19-100025544 - Mayer Doa' as Remarks, 'Customer  :Mayer Doa' as MarkerName,'23.746708177' as Latitude,'90.426175853' as Longitude ,'CustLocation' as Ref ";
